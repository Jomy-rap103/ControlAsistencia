...
public class VistaAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnPaginaP, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 310, 287, 52));
    ...
    PanelModificar panelModUsuario = new PanelModificar();
    ...
    private void btnModificarESActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarESActionPerformed
        PanelModificarHorarios panelModHora = new PanelModificarHorarios();
