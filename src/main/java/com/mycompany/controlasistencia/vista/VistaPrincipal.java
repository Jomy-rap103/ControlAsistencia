...
public class VistaPrincipal extends javax.swing.JFrame {
    ...
    // --- Gestión segura de cámara ---
private final java.util.concurrent.atomic.AtomicBoolean apagandoCamara =
        new java.util.concurrent.atomic.AtomicBoolean(false);

private final java.util.concurrent.ExecutorService camIO =
        java.util.concurrent.Executors.newSingleThreadExecutor(r -> {
            Thread t = new Thread(r, "cam-io");
            t.setDaemon(true);
            return t;
        });
   ...
   private final java.time.format.DateTimeFormatter DF = java.time.format.DateTimeFormatter.ofPattern("dd/MM/yyyy");
    ...
    public VistaPrincipal(Usuario usuario ) {
        ...
        //Borrar si no funciona ⬇️ los emoji los puse yo....
    ...
    private void initComponents() {
        ...
        background.add(btnActivarSalida, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 370, 150, 30));
        ...
        background.add(panelCamara, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 90, 450, 260));
        ...
        background.add(btnActivarEntrada, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 370, 150, 30));
        ...
        background.add(btnApagarCamara, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 370, 150, 30));
    ...
    try {
        ...
        logger.warning("Error al apagar la camara: " + e.getMessage());
    }
}
