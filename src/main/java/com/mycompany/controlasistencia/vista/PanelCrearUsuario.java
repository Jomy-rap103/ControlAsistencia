...
public class PanelCrearUsuario extends javax.swing.JPanel {
    ...
    //Aqui verifica si nombre o apellido cumple con la regla    
    ...
    //Elimina guiones, punto y espacio
    ...
    //se obtienen y normalizan los datos
    ...
    //crea el nuevo usuario y registra quien lo creo
    if (actor != null) {
    ...
    private void cargarRolesEnCombo() {
        ...
        try {
            ...
            e.printStackTrace();
            //en caso de error usa los datos del caché
            for (Roles r : rolesCache) model.addElement(r.getNombre());
        }
        boxRoles.setModel(model);
    }
    
    //Devuelve el id del rol seleccionado en el comboBox
